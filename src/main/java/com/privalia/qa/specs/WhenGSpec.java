...
public class WhenGSpec extends BaseGSpec {
     ...
     *
     * @param text      Text to write on the element
     * @param index     Index of the webelement in the list
     */
     ...
     * comma (,) or spaces ( )
     *
     * @param strokes       key stroke to send
     ...
     *
     * @param requestType   type of request to be sent. Possible values:                      GET|DELETE|POST|PUT|CONNECT|PATCH|HEAD|OPTIONS|REQUEST|TRACE
     ...
     * @param foo         parameter generated by cucumber because of the optional expression
     * @param loginInfo   the login info (for basic auth)
     * @param bar         parameter generated by cucumber because of the optional expression
     * @param baseData    the base data (data to send in body case of POST)
     * @param baz         parameter generated by cucumber because of the optional expression
     * @param type        the type of the base data (json or string)
     ...
     *
     * @param timeout     the maximum time to check for the response
     * @param wait        the wait between checking intervals
     * @param requestType the request type
     * @param endPoint    the end point
     * @param contains    String to match the gherkin with optional parameter
     * @param responseVal the expected value
     * @throws Exception the exception
     */
