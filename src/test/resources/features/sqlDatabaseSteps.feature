...
#    Given I connect with JDBC to database 'postgres' type 'postgres' on host '172.17.0.1' and port '5432' with user 'postgres' and password 'postgres'
#    Then I close database connection
...
#    Then I close database connection
  ...
  Scenario: Executing SELECT statements on a MySQL database
    ...
    Then I check that result is:
      ...
      | San Francisco  |  15	 |    43	|  0	|2004-11-29 |
