...
Feature: Steps for testing web pages
  ...
  for automating or testing. If you would like to run this tests, you can substitute http://localhost by
  ...
  Rule: Opening the browser, navigating and managing windows
    ...
    Scenario: Open the browser and go to page
      Given I go to 'http://localhost/styled/index.html'
    ...
    Scenario: Check that a new window opened
      Given I go to 'http://localhost/styled/windows-test.html'
    ...
    Scenario: Check the current url
      Given I go to 'http://localhost/styled/index.html'
      Then we are in page 'http://localhost/styled/index.html'
  ...
  Rule: Checking elements properties
    ...
    Scenario: Verify if element is displayed
      Given I go to 'http://localhost/styled/tag/dynamic-table.html'
    ...
    Scenario: Verify if element is enabled
      Given I go to 'http://localhost/styled/dynamic-buttons-disabled.html'
  ...
  Rule: Interacting with elements
    ...
    Scenario: Perform click on the an element
      Given I go to 'http://localhost/styled/events/javascript-events.html'
  ...
  Rule: Waiting for elements
    ...
    Scenario: Wait until the element is present
      Given I go to 'http://localhost/styled/dynamic-buttons-simple.html'
  ...
  Rule: Managing alerts
    ...
    Scenario: Dismiss an alert
      Given I go to 'http://localhost/styled/alerts/alert-test.html'
  ...
  Rule: Dealing with iframes
    ...
    Scenario: Switch to iframe by locator
      Given I go to 'http://localhost/styled/iframes-test.html'
